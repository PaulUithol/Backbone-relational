/**!
 * Backbone Relational v0.10.0 (backbone-relational.js)
 * ----------------------------------
...
(function (global, factory) {
	...
	module$1.Collection = Backbone.Collection.extend();
	module$1.showWarnings = true;
	 ...
	 */
	module$1.BlockingQueue = function () {
		this._queue = [];
	};
	_.extend(module$1.BlockingQueue.prototype, module$1.Semaphore, {
		_queue: null,
	...
	_.extend(module$1.Store.prototype, Backbone.Events, {
		/**
	 ...
	 * @param {Object} opts
	 */
	module$1.Relation = function (instance, options, opts) {
	...
	// Fix inheritance :\
	module$1.Relation.extend = Backbone.Model.extend;
	// Set up all inheritable **Backbone.Relation** properties and methods.
	_.extend(module$1.Relation.prototype, Backbone.Events, module$1.Semaphore, {
		options: {
			createModels: true,
			includeInJSON: true,
	 ...
	 */
	module$1.Model = Backbone.Model.extend({
	  ...
	  */
		...
		deferArray: function deferArray(_deferArray) {
			return Backbone.$.when.apply(null, _deferArray);
		},
	...
	_.extend(module$1.Model.prototype, module$1.Semaphore);
